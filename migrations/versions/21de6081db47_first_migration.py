...
Revision ID: 21de6081db47
Revises: 
Create Date: 2020-11-29 14:53:54.959879
...
def upgrade():
    ...
    op.create_index('uix_project_codename', 'project', ['codename'], unique=True, postgresql_where=sa.text('project_id IS NULL'))
    op.create_index('uix_project_codename_project_id', 'project', ['codename', 'project_id'], unique=True, postgresql_where=sa.text('project_id IS NOT NULL'))
    ...
    sa.Column('content_type', sa.Enum('video', 'audio', 'image', 'text', name='filetype'), nullable=False),
